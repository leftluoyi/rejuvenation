$(document).ready(() => {
  ...
  $.getJSON('Authorization.json', async (data) => {
    ...
    const authorization = await Authorization.at('0x05a1DF46cB529c30B3e1cDbB2FEa277F363360C4');
